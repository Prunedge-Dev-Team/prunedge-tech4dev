...
window.addEventListener("DOMContentLoaded", () => {
    ...
    .addEventListener("scroll", () => scrollWatcher("program-scroll-btn", "programs-wrapper"));
    ...
    .addEventListener("scroll", () => scrollWatcher("testimonial-scroll-btn", "testimonials-wrapper"));
...
const testimonialImages = [...document.querySelectorAll(".testimonial__image")].map((el) =>
    transformElement(el, "./assets/images/female-avatar.png")
);
...
const counterFunction = () => {
    ...
    const finalCount = ["201,382", "961,111", "192", "1000+", "22"];
    const speed = 200;
